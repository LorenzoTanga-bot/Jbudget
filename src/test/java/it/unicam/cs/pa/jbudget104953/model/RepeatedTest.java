...
public class RepeatedTest {
    ...
    int ID = 0;
    TypeMovement type = TypeMovement.REPEATED;
    ...
    void repeatedTest() {
        ...
        MovementInterface repeated = new Movement(ID, type, initialTransaction, relatedTransaction, typeScope, ratio);

        DirectorMovement.getInstance().makeRepeatedMovement(initialTransaction, relatedTransaction);
        MovementInterface repeatedCompare = DirectorMovement.getInstance().getResult();

        compare(repeated, repeatedCompare);
    }
}